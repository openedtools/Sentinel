...
const USERS = [
  { id:'u01',  name:'A. Johnson',      role:'SOC Analyst',            dept:'SecOps',   priv:'Standard',       mfa:true,  lastLogin:'TODAY 05:42', accountAge:'1.2 yrs', risk:'Low',      groups:['SOC-Analysts'],                          notes:'' },
  { id:'u02',  name:'L. Culhane',      role:'SOC Analyst',            dept:'SecOps',   priv:'Standard',       mfa:true,  lastLogin:'TODAY 06:01', accountAge:'2.1 yrs', risk:'Low',      groups:['SOC-Analysts'],                          notes:'' },
  { id:'u03',  name:'Admin-Primary',   role:'Domain Administrator',   dept:'IT-OPS',   priv:'Domain Admin',   mfa:false, lastLogin:'3 DAYS AGO22:10', accountAge:'5.4 yrs', risk:'Critical', groups:['Domain Admins','Enterprise Admins'],    notes:'No MFA on DA account' },
  { id:'u04',  name:'svc_backup',      role:'Backup Service Account', dept:'IT-OPS',   priv:'Local Admin',    mfa:false, lastLogin:'TODAY 04:33', accountAge:'3.8 yrs', risk:'High',     groups:['Backup-Operators','Domain Admins'],      notes:'Service acct in Domain Admins — least privilege violation' },
  { id:'u05',  name:'svc_backup_new',  role:'Service Account (NEW)',  dept:'IT-OPS',   priv:'Domain Admin',   mfa:false, lastLogin:'TODAY 04:47', accountAge:'0 days',  risk:'Critical', groups:['Domain Admins','Administrators'],        notes:'Created outside change window — active incident' },
  { id:'u06',  name:'CEO-Office',      role:'Chief Executive Officer',dept:'Executive',priv:'Privileged User', mfa:true,  lastLogin:'TODAY 07:12', accountAge:'6.1 yrs', risk:'Medium',   groups:['Executives','Finance-Read'],             notes:'Deepfake delivery target' },
  { id:'u07',  name:'CFO-Office',      role:'Chief Financial Officer',dept:'Finance',  priv:'Privileged User', mfa:true,  lastLogin:'TODAY 06:44', accountAge:'4.2 yrs', risk:'High',     groups:['Executives','Finance-Full','Wire-Auth'], notes:'Spear-phish target (WormGPT)' },
  ...
  { id:'u09',  name:'T. Park',         role:'IT Support Specialist',  dept:'IT-OPS',   priv:'Local Admin',    mfa:true,  lastLogin:'TODAY 02:14', accountAge:'1.8 yrs', risk:'High',     groups:['IT-Support','Local-Admins'],             notes:'Workstation WS-004 compromised' },
  ...
  { id:'u11',  name:'dev-alice',       role:'Software Engineer',      dept:'Dev-Ops',  priv:'Standard',       mfa:true,  lastLogin:'TODAY 08:00', accountAge:'0.9 yrs', risk:'Low',      groups:['Developers','Git-Contributors'],          notes:'' },
  { id:'u12',  name:'hr-manager',      role:'HR Manager',             dept:'HR',       priv:'Privileged User', mfa:false, lastLogin:'YESTERDAY14:23', accountAge:'3.5 yrs', risk:'High',     groups:['HR-Staff','HR-PII-Full','Finance-Read'],  notes:'HR data access without MFA' },
  ...
  { id:'u14',  name:'svc_legacy_app',  role:'Legacy App Service Acct',dept:'Finance',  priv:'Privileged User', mfa:false, lastLogin:'TODAY 00:02', accountAge:'7.2 yrs', risk:'Medium',   groups:['Legacy-App-Users','DB-Readers'],          notes:'Service account with interactive logon enabled' },
  { id:'u15',  name:'finance-user',    role:'Finance Analyst',        dept:'Finance',  priv:'Standard',       mfa:true,  lastLogin:'TODAY 07:55', accountAge:'1.1 yrs', risk:'Low',      groups:['Finance-Read'],                           notes:'' },
];
